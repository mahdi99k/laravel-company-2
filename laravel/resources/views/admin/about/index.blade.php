...
@section('content')
    ...
    <section class="row m-0">
        ...
        <section class="col-8 offset-2 text-center mt-3">
            <h2 class="text-white font-weight-bold">This Page Is About</h2>
        </section>
                ...
                @forelse ($about as $item)
                    ...
                    <tr class="text-center">
                        <td>{{ $item->title }}</td>
                        <td><img src="{{ asset("/images/about/" . $item->image) }}" width="100" height="50"></td>
                        <td>{{ $item->alt }}</td>
                        <td>{{ \Illuminate\Support\Str::limit($item->description , 50) }}</td>

                        <td>
                            <a href="{{ route('about.edit' , ['id' => $item->id]) }}" class="btn btn-info text-white">Update</a>
                        </td>
            ...
            <a href="{{route('about.create')}}" class="btn btn-success text-capitalize">go to create about website</a>
