    ...
    <section class="row m-0">
        ...
        <section class="col-8 offset-2 mt-4 p-5 bg-secondary text-capitalize text-white">
            ...
            <section class="form-group">
                ...
                <p class="text-center"><img src="{{ asset("images/product/" . $product->image) }}" width="170" height="100"></p>
                @error('image')
                <p class="text-center alert alert-danger p-1">{{ $message }}</p>
                @enderror
            </section>
            ...
            <section class="form-group">
                ...
                {!! Form::text('webTitle' , $product->title_web , ['class' => 'form-control mb-4' , 'style' => '2px inset lightgray',
