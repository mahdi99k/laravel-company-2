...
@section('content')
    ...
    <section class="row m-0">
        ...
        <section class="col-8 offset-2 text-center mt-4">
            <h2 class="text-white font-weight-bold">This Page Is Social</h2>
        </section>
        ...
        <section class="col-10 offset-1 mt-4 p-3 bg-secondary">
            <table class="table table-bordered table-responsive-xl table-hover table-dark">
                ...
                @forelse($social as $item)
                    ...
                    <tr class="text-center">
                        ...
                        <td>{{ \Illuminate\Support\Str::limit($item->linkedin , 21) }}</td>
                        <td>{{ \Illuminate\Support\Str::limit($item->twitter , 30) }}</td>

                        <td>
                            <a href="{{ route("social.edit" , ['id' => $item->id]) }}" class="btn btn-info text-white">Update</a>
                        </td>
            ...
            {{ $social->links() }}{{-- paginate --}}

            <a href="{{ route('social.create') }}" class="btn btn-success text-capitalize">go to create social website</a>
